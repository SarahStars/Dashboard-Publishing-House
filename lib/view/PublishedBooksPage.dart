...
class PublishedBooksPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<String> categories = ['ديني', 'تاريخي', 'روايات', 'تراثي', 'أطفال', 'علمي'];
                      ...
                      itemBuilder: (_, index) {
                        return ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: index == 0 ? Colors.red[800] : Colors.grey[300],
  ...
  Navigator.of(context).push(
    MaterialPageRoute(builder: (_) => const PublishABook()),
  );
}),
